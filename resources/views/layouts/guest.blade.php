...
<body class="min-h-screen flex">
    ...
    <div
        ...
        <div class="flex-0 flex items-center justify-center bg-gradient-to-br from-blue-800 to-purple-700">
            <img src="{{ asset('img/login1.jpg') }}" alt="Ilustración login"
                class="h-[400px] w-auto object-cover rounded-2xl shadow-2xl overflow-hidden" />
        </div>
    ...
    <div class="flex flex-col flex-1 justify-center items-center bg-gray-50 p-8">
        <div class="w-full max-w-md bg-white rounded-lg shadow-lg p-10">
            <div class="flex justify-center mb-8">
                {{-- Logo opcional --}}
                <img src="{{ asset('img/ALN.png') }}" alt="Logo"
